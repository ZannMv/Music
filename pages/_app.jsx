...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/noctichorizon",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=1353539362985349201&permissions=8&integration_type=0&scope=bot+applications.commands",
    },
    {
      link: true,
      name: "Partners",
